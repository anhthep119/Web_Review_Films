            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-body pb-3">
                    <form action="{{ route('account.myReviews.updateReview',$review->id) }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="name" class="form-label">Phim</label>
                            <div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('review') is-invalid @enderror" name="review" id="review" cols="30" rows="7" placeholder="Nhập bình luận trên 10 ký tự">{{ old('review',$review->review) }}</textarea>
                            @error('review')
                                <p class="invalid-feedback">{{ $message }}</p>
                            @enderror
                        </div>
